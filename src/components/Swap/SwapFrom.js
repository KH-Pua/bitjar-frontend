  ...
  return (
    <div className="flex flex-row items-center">
      ...
      <section>
        <div className="dropdown dropdown-bottom w-full md:w-[32.5%] lg:w-[20%]">
          <div
            tabIndex={0}
            role="button"
            className=" my-1 flex h-12 w-48 flex-row items-center rounded-l-md border-b-[1px] border-l-[1px] border-t-[1px] border-black p-1 py-2 hover:bg-slate-200"
          >
            <div>
              {coin ? (
      ...
      <input
        ...
        className="h-12 w-[120px] rounded-r-md border-[1px] border-black text-center"
      />
    </div>
  );
};
